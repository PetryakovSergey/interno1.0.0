<template>
    <div class="tags-block center">
        <h2 class="tags-block__main-heading">Architecture Lorem ipsum dolor sit amet.</h2>
        <img class="tags-block__img" :src="require('@/assets/img/post-photo.webp')" alt="main-photo">
